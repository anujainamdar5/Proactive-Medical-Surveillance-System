...
namespace WebApplication5
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        public int count_documents()
        {
            ...
            var filter = Builders<BsonDocument>.Filter.Eq("token_no", token_no) & Builders<BsonDocument>.Filter.Eq("Session_code", session_code);
        ...
        protected void save_Click(object sender, EventArgs e)
        {
          //  string session_code = ConfigurationManager.AppSettings["sessioncode"];
            ...
            {
                {"token_no",token_no}, // focus on this
                { "Session_code",session_code},
                {"Fitness",RadioButtonList1.SelectedValue},
                { "Advice",TextBox3.Text}
           };

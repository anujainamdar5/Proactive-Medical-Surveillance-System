...
namespace WebApplication5
{
    public partial class ecg : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            filter = Builders<BsonDocument>.Filter.Eq("metadata.session_code", Label5.Text) & Builders<BsonDocument>.Filter.Eq("metadata.test", "ecg");
             Label4.Text= collection.Find(filter).Count().ToString();
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="investigation.aspx.cs" Inherits="WebApplication5.investigation" %>
    ...
    <table class="auto-style47">
        ...
        <asp:Panel ID="test_pan" runat="server">
            <table style="width:100%;">
                ...
                <tr>
                    <td class="auto-style14">&nbsp;</td>
                    <td class="auto-style29">Blood sample:</td>
                    <td class="auto-style16">
                        <asp:RadioButtonList ID="blood" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged1">
                            <asp:ListItem Selected="True" Value="Not Taken">Not Taken</asp:ListItem>
                ...
                <tr>
                    <td class="auto-style14">&nbsp;</td>
                    <td class="auto-style29">Urine sample:</td>
                    <td class="auto-style16">
                        <asp:RadioButtonList ID="urine" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged1">
                            <asp:ListItem Selected="True" Value="Not Taken">Not Taken</asp:ListItem>
                            <asp:ListItem Value="Taken"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                ...
                <tr>
                    <td class="auto-style14">&nbsp;</td>
                    <td class="auto-style29">Sputum sample:</td>
                    <td class="auto-style16">
                        <asp:RadioButtonList ID="sputum" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged1">
                            <asp:ListItem Selected="True" Value="Not Taken">Not Taken</asp:ListItem>
                            <asp:ListItem Value="Taken"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                ...
                <tr>
                    <td class="auto-style14">&nbsp;</td>
                    <td class="auto-style29">Stool sample:</td>
                    <td class="auto-style16">
                        <asp:RadioButtonList ID="stool" runat="server" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged1">
                            <asp:ListItem Selected="True" Value="Not Taken">Not Taken</asp:ListItem>
                            <asp:ListItem Value="Taken"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>

...
namespace WebApplication5
{
    public partial class ht_distri : System.Web.UI.Page
    {
        ...
        public void get_values()
        {
            ...
            var filter = Builders<BsonDocument>.Filter.Eq("Session_code", "1289968636"); //& Builders<BsonDocument>.Filter.Gt("height", "151") & Builders<BsonDocument>.Filter.Lt("height", "161");
            ...
            using (cursor.Result)
            {
                while (cursor.Result.MoveNextAsync().Result)
                {
                    ...
                    {
                        string weight = cursor.Result.Current.ElementAt<BsonDocument>(i)["weight"].ToString();

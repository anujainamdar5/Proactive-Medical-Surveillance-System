<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xray.aspx.cs" Inherits="WebApplication5.xray" %>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style29">
                        <asp:Label ID="Label5" runat="server" Text="X-ray "></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style55">
                        <asp:Button ID="browser" runat="server" OnClick="browser_Click" Text="Browse" style="height: 26px; width: 63px" />
                    </td>
                    <td class="auto-style2">
